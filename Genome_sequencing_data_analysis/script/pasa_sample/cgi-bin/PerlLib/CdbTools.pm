...
sub cdbyank {
    ...
    unless (-s "$fastaFile.cidx") {
        ...
        my $cmd = "/PUBLIC/software/public/Gene_predict/PASA/PASA_r20140417/bin/cdbfasta -C $fastaFile";
        my $ret = system $cmd;
        if ($ret) {
    ...
    my $cmd = "/PUBLIC/software/public/Gene_predict/PASA/PASA_r20140417/bin/cdbyank -a \'$accession\' $fastaFile.cidx";
